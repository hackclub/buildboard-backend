...
class User(Base):
    ...
    identity_vault_id: Mapped[str | None] = mapped_column(String(255), nullable=True, unique=True, index=True)
    identity_vault_access_token: Mapped[str | None] = mapped_column(String(512), nullable=True)
    idv_country: Mapped[str | None] = mapped_column(String(10), nullable=True)
    verification_status: Mapped[str | None] = mapped_column(String(32), nullable=True)
    ysws_eligible: Mapped[bool | None] = mapped_column(nullable=True)
